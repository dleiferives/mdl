...
MDL is a typed compiler for Minecraft Java Edition datapacks. The current
implementation is written in Rust and is being rebuilt in verified stages: a
vanilla-server test harness and the typed Core SSA representation are complete.
The target-aware Minecraft IR and datapack emitter are next.

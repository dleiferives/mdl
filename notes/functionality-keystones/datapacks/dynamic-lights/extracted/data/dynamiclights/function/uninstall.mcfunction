...
datapack disable "mod/dynamiclights"
datapack disable "file/dynamiclights-v1.9.3-mc1.17-26.2.9-datapack.zip"

say ⏻ Dynamic Lights v1.9.3 by Tschipcraft has been uninstalled by @s! It is safe to disable and remove the data pack/mod.

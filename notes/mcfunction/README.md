...
- [How do command success, result, and missing contexts compose?](command-outcomes.md)
- [When are newly summoned entities safe to query?](entity-activation.md)
- [What is the exact Java 26.2 written-book/entity path?](written-books-26.2.md)
